...
class marriageHalls extends CI_Controller {
  ...
  public function create()
  {
      $user = $this->session->userdata('user');
      $data['user'] = $user;
      return $this->load->view('createHalls',$data);
  }
  ...
  public function insertdata()
  {
      ...
      // get foto
      $config['upload_path'] = './assets/images/marriageHallimages';
      ...
      if (!empty($_FILES['fotopost']['name'])) {
          if ( $this->upload->do_upload('fotopost') ) {
              ...
              $this->MarriageHalls_model->insert($data);
              $this->session->set_flashdata('success','Record added successfully !');
              redirect(base_url().'index.php/marriageHalls/index');
          }else {
                 $this->load->view('failmh',$data);
          }
      }else {
  ...
  {
      $path = './assets/images/marriageHallimages/';
      @unlink($path.$foto);

      $where = array('id' => $id );
      $this->MarriageHalls_model->delete($where);
      $this->session->set_flashdata('success','Record deleted successfully !');
      return redirect(base_url().'index.php/marriageHalls/index');
  }
  ...
  public function edit($id)
  {
      ...
      $data['data'] = $this->MarriageHalls_model->get_by_id($condition);
      return $this->load->view('editMarriageHalls',$data);
  }
  ...
  public function updatedata()
  {
      ...
      if (!empty($_FILES['fotopost']['name'])) {
          if ( $this->upload->do_upload('fotopost') ) {
              ...
              $this->MarriageHalls_model->update($data,$condition);
