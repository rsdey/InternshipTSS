...
<div class="row" >
      <div class="col-12" style="padding-left: 50px"><h3>Edit Sansthas Data </h3></div>
      </div></div>
<hr>

<div class="row">
        <div class="col-md-6">
        <form action="<?=base_url()?>index.php/sansthas/updatedata" method="post" enctype="multipart/form-data">
          <label>Name</label>
