...
<div class="row" >
      <div class="col-12" style="padding-left: 50px"><h3>Add Marriage Halls Data </h3></div>
      </div></div>
<hr>

<div class="row">
        <div class="col-md-6">
        <form action="<?=base_url()?>index.php/MarriageHalls/insertdata" method="post" enctype="multipart/form-data">
          <label>Name</label>
