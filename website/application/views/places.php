		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto animated slideInUp" style="animation-delay: 0.1s;">
					...
					<li class="nav-item">
						<a class="nav-link active" style="color:black;" href="<?php echo base_url().'index.php/AlandiDarshan/places'?>">Places</a>
					</li>
	...
	<div class="row">
		<div class="col-sm-4" style="margin-top: 2rem;">
			<div class="card" style="width: 18rem">
				<img src="<?php echo base_url().'data/images/Img1.jpg';?>" class="card-img-top" height="200px">
				<div class="card-body">
		...
		<div class="col-sm-4" style="margin-top: 2rem;">
			<div class="card" style="width: 18rem">
				<img src="<?php echo base_url().'data/images/Img2.jpg';?>" class="card-img-top" height="200px">
				<div class="card-body">
					<h5 class="card-title">Place 1</h5>
					<p class="card-text">
					Description of the place. Description of the place.Description of the place.Description of the place</p>
		...
		<div class="col-sm-4" style="margin-top: 2rem;">
			<div class="card" style="width: 18rem">
				<img src="<?php echo base_url().'data/images/Img3.jpg';?>" class="card-img-top" height="200px">
				<div class="card-body">
					<h5 class="card-title">Place 1</h5>
					<p class="card-text">
					Description of the place. Description of the place.Description of the place.Description of the place</p>
...
<br><footer  class="footerc" style="background-image: url('images/footerb.jpg'); opacity: 0.9; color: Black;padding-top: 15px;background: #FFF47D;">
			<div class="container">
