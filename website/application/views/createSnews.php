...
<div class="row" >
      <div class="col-12" style="padding-left: 50px"><h3>Create Scrolling News </h3></div>

    </div></div>
<hr>

<form method="post" name="createUser" action="<?php echo base_url().'index.php/Snews/createSnews';?>">
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group">
         ...
         <textarea rows = "5" cols = "100" name = "snews" class="form-control">
          </textarea><?php echo form_error('snews'); ?>
        </div>
