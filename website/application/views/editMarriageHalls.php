...
<div class="row" >
      <div class="col-12" style="padding-left: 50px"><h3>Edit Marriage Halls Data </h3></div>
      </div></div>
<hr>

<div class="row">
        <div class="col-md-6">
        <form action="<?=base_url()?>index.php/marriageHalls/updatedata" method="post" enctype="multipart/form-data">
          <label>Name</label>
          <input type="text" name="name" class="form-control" value="<?=$data->name?>">
          <label>Description</label>
          <textarea name="description" rows="8" class="form-control" cols="80"><?=$data->description?></textarea>
          ...
          <a href="<?php echo base_url().'index.php/marriageHalls'; ?>" class="btn btn-secondary ">Cancel</a>
        </form>
        </div>
      </div>
    </div>
