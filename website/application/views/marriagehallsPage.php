...
<main>
	<div class="container" style="padding-left: 50px"><h1>Marriage Halls</h1><hr class="text-Black">

			 <div class="row">
      <div class="col-md-12">
      <form action="<?=base_url()?>index.php/AlandiDarshan/marriagehallsPage" method="get">
        ...
        <a href="<?=base_url()?>index.php/AlandiDarshan/marriagehallsPage" class="btn btn-secondary ">Cancel</a>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="<?=base_url()?>assets/images/marriageHallimages/<?=$data->image?>" height="250px">
